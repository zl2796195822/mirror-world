...
Persistent Digital Society 的工程仓库。当前执行 M1-T03：World Overview；世界事实、居民、事件、API、3D、AI 与模拟能力按后续任务逐步接入。
