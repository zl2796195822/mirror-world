...
- M0、M1-T01 已通过；当前只执行 M1-T02「开发身份」。
- 本轮不得执行 M1-T03、M1-T04、M2 或任何后续任务。
- M1-T02 只实现开发环境 seed 用户、可替换 Auth Adapter 与 fail-closed 的生产配置；不实现真实登录、World Overview 数据、API、世界、居民、3D、AI、数字人、模拟器或 Worker。
